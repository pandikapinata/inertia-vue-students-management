...
const form = useForm({
    ...
    kelas_id: student.data.kelas_id,
...
onMounted(() => {
    getSections(student.data.kelas_id);
});

const getSections = (kelas_id) => {
    axios.get("/sections?kelas_id=" + kelas_id).then((response) => {
